...
const NavigationAuth = props =>
  props.currentNav === "instructor" ? (
    <InstructorNav DisplayName={props.DisplayName} authUser={props.authUser} />
  ) : (
    <DesignNav DisplayName={props.DisplayName} authUser={props.authUser} />
  );
  ...
  >
    ...
    <Navbar.Collapse>
      <Nav style={{ fontSize: "20px", marginLeft: "34%" }}>
        <NavItem style={{ float: "right" }} eventKey={1}>
          Design a Course
        </NavItem>
      </Nav>
      <Nav pullRight>
